...
import CheckoutCard, { InvoiceData } from "@/components/checkoutcard"; // Ensure this path is correct
import { Zap } from "lucide-react";

export default function CreateInvoicePage() {
  // 1. SHARED STATE: This holds the live data for the form AND the preview
  ...
  // 2. HANDLER: This function will be passed to the form to update our state
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto py-10 px-6 lg:px-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="bg-[#0A0A0B] border border-white/5 rounded-[2.5rem] p-6 md:p-10 shadow-2xl animate-in slide-in-from-left-8 duration-700">
             {/* Pass the current data and the update function to the form */}
          ...
          <div className="sticky top-10 hidden lg:flex flex-col items-center animate-in slide-in-from-right-8 duration-700">
            ...
            {/* Using the same component that clients will see! */}
